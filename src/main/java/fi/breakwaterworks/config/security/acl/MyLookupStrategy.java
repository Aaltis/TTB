...
public class MyLookupStrategy implements LookupStrategy {
	...
	private MyAclClassIdUtils aclClassIdUtils;
	 ...
	 */
	public MyLookupStrategy(DataSource dataSource, AclCache aclCache,
	...
	public MyLookupStrategy(DataSource dataSource, AclCache aclCache,
		...
		this.aclClassIdUtils = new MyAclClassIdUtils();
	...
	public final void setConversionService(ConversionService conversionService) {
		this.aclClassIdUtils = new MyAclClassIdUtils(conversionService);
	}
